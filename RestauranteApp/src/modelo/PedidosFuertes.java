 ...
 * @author Jeimy
 */
public class PedidosFuertes extends FabricaPedido{

    public PedidosFuertes(String numeroPedido, String nombrePedido, int cantidad, String precio1, String total) {
        super(numeroPedido, nombrePedido, cantidad, precio1, total);
    }

    public PedidosFuertes() {
    }
